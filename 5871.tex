...
\multicolumn{10}{c}{Ведомость посещения занятий по микроконтроллерам студентами 5871 группы} \\
\toprule
%&&&&&\\
&&&&&\\
&&&&&\\
...
&\rotatebox{90}{\rlap{\small 18 октября /оценки}}
...
\midrule
		...
		4\,&Козлов Андрей Александрович      \ok\ok&$2$ \ok\MP &3&$\cdot$\\
