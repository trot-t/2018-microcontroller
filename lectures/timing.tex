...
\draw[yellow, dashed]  ({2*\D + \lineL}, {\D+\DD/6*1.3}) -- ({2*\D+2*\DD},{\D+\DD/6*1.3});
\draw[green, dashed]  ({2*\D + \lineL}, {\D+\DD/2}) -- ({2*\D+2*\DD},{\D+\DD/2});
\draw[red, dashed]  ({2*\D + \lineL}, {\D+2*\DD/3}) -- ({2*\D+2*\DD},{\D+2*\DD/3});
