...
\draw(1.25,3.5)node[nigbt,bodydiode](npn1){};%{\tiny{$VT_1$}};% 1 ряд 
\draw (1.25,1) node[nigbt,bodydiode](npn4){};%{\tiny{$VT_4$}};%1ряд
\draw (npn1.S) -- (npn4.D);


\draw(3,3.5)node[nigbt,bodydiode](npn3){};%{\tiny{$VT_3$}};% 2 ряд 
\draw (3,1) node[nigbt,bodydiode](npn6){};%{\tiny{$VT_6$}};% 2ряд
\draw (npn3.S) -- (npn6.D);


\draw(4.75,3.5)node[nigbt,bodydiode](npn5){};%{\tiny{$VT_5$}};%последний ряд 
\draw (4.75,1) node[nigbt,bodydiode](npn2){};%{\tiny{$VT_2$}};%последний ряд
\draw (npn5.S) -- (npn2.D);


\draw (0,4.05) -- (npn1.D) node[above]{1} -- (npn3.D) node[above]{3} -- (npn5.D) node[above]{5}; % плюсовая шина
\draw (0,0.45) -- (npn4.S) node[below]{4} -- (npn6.S) node[below]{6} -- (npn2.S) node[below]{2}; % минусовая шина
\draw (4.75,1.85)   node[left]{\small$C$} to[short,*-] (5.2,1.85) to[L] (6,1.85);    %катуха С
\draw (3,2.25) node[left]{\small$B$} to[short,*-] (5.2,2.25) to[L] (6,2.25);  % катуха В
